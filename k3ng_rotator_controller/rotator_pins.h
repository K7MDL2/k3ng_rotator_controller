...
#define rotator_analog_az A10     // reads analog azimuth voltage from rotator - pin 4 on Yaesu connector
...
#define rotation_indication_pin 0  // light LED solid when rotator is in motion.  ROTATION_INDICATOR_PIN_ACTIVE_STATE in settings.h defines Active state
#define blink_led 0
